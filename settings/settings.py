...
FIGER_ONLY_TYPES = ['PERSON.POLITICIAN', 'EVENT.PROTEST', 'PARK', 'FINANCE.CURRENCY', 'LOCATION.PROVINCE',
                    ...
                    'ORGANIZATION.SPORTS_LEAGUE', 'EDUCATION.DEPARTMENT', 'PRODUCT.AIRPLANE', 'BIOLOGY', 'LIVING_THING',
                    ...
                    'COMPUTER.ALGORITHM', 'LOCATION.BODY_OF_WATER', 'LANGUAGE', 'BUILDING.LIBRARY', 'PERSON.TERRORIST',
                    ...
                    'PRODUCT.CAMERA', 'BROADCAST.TV_CHANNEL', 'TRANSPORTATION.ROAD', 'CHEMISTRY', 'GEOGRAPHY.ISLAND',
                    ...
                    'EDUCATION.EDUCATIONAL_DEGREE', 'TRANSIT', 'PERSON.ENGINEER', 'ORGANIZATION.SPORTS_TEAM', 'EVENT',
                    'GOVERNMENT.GOVERNMENT', 'PERSON.COACH', 'MEDICINE.DRUG', 'PRODUCT.MOBILE_PHONE', 'PERSON.DIRECTOR',
...
TAG2VEC_CLASS_LIST = FIGER_CLASS_LIST
EVALUATION_CLASS_LIST = FIGER_CLASS_LIST

KERAS_DECODER = 'max'  # 'max' or 'top'
KERAS_MAX_DECODER_NB = 2
KERAS_TOP_DECODER_NB = 0.9
