...
def split_dataset(traintest_fp, train_fp, test_fp, test_perc=0.2, sentence_nb=0, print_every=100000):
    current_sentence = 0
    tagged_words = []

    with open(traintest_fp) as in_f, \
            open(train_fp, 'w') as training_f, \
            open(test_fp, 'w') as test_f:
